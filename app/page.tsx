...
export const metadata: Metadata = {
  ...
  description: 'Boutique spécialisée en cartes Pokémon japonaises authentiques — singles AR, SAR, ex, CHR importés directement du Japon.',
}
      ...
      <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          <p className="animate-fade-in-up delay-300 text-gray-300 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
            Cartes Pokémon japonaises authentiques — AR, SAR, ex, CHR
            introuvables en France, importées directement du Japon pour les vrais collectionneurs.
          </p>
          ...
          <div className="animate-fade-in-up delay-400 flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/boutique" className="group px-8 py-4 bg-pokemon-red hover:bg-red-700 text-white font-bold rounded-2xl transition-all duration-300 hover:scale-105 shadow-lg shadow-red-950/60 flex items-center gap-2 justify-center">
              <span>Cartes à l&apos;unité</span>
              <span className="group-hover:translate-x-1 transition-transform">→</span>
            </Link>
            <Link href="/cartes-gradees" className="px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white font-semibold rounded-2xl transition-all duration-300">
              Cartes Gradées
            </Link>
          </div>
        </div>
      ...
      <section className="py-10 px-4 border-y border-white/5 bg-white/[0.01]">
        <div className="max-w-4xl mx-auto grid grid-cols-3 gap-4 text-center">
          {[
            ...
            { value: '48h',            label: 'Expédition',      emoji: '🚀' },
            { value: '100%',           label: 'Authentique',     emoji: '🇯🇵' },
      ...
      <section className="py-20 px-4 jp-pattern">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: "🇯🇵", kanji: "本物", titre: "100% Authentique", texte: "Cartes importées directement du Japon. Chaque carte est vérifiée et authentifiée avant l'envoi." },
              { icon: "📦", kanji: "安心", titre: "Emballage soigné", texte: "Vos cartes sont protégées avec soin — sleeve + top loader systématiques pour un envoi en parfait état." },
      ...
      <section className="py-24 px-4">
        <div className="max-w-2xl mx-auto text-center relative">
          ...
          <div className="relative border border-red-900/20 rounded-3xl p-12">
            ...
            <h2 className="text-3xl font-black text-white mb-4">Commencez votre collection japonaise</h2>
            <p className="text-gray-400 mb-8">
              {cartesCount} cartes disponibles — importées directement du Japon.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/cartes-gradees" className="inline-block px-8 py-4 bg-white/5 border border-white/10 hover:bg-white/10 text-white font-semibold rounded-2xl transition-all duration-300">
                Cartes Gradées
              </Link>
            </div>
          </div>
